...
@Tag(name = "Stock Movement APIs", description = "Lịch sử biến động tồn kho")
public class StockMovementController {

    private final StockMovementService stockMovementService;

    @GetMapping
    @Operation(summary = "Lịch sử biến động tồn kho",
            description = "Phân trang; lọc theo kho, vị trí, sản phẩm, loại biến động, khoảng thời gian")
    public ApiResponse<PagedResponse<StockMovementResponse>> getAll(
            ...
            @Parameter(description = "Loại biến động: INBOUND, OUTBOUND, ADJUSTMENT, RESERVE, RELEASE")
