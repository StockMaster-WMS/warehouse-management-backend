...
@RequestMapping("/api/products/audit-logs")
public class ProductAuditLogController {
    ...
    public ApiResponse<PagedResponse<AuditLogResponse>> getAuditLogs(
        ...
        return ApiResponse.success("Lấy nhật ký sản phẩm thành công",
                auditLogService.findAll(pageable, "PRODUCT", actionType, entityType, keyword));
    }
}
